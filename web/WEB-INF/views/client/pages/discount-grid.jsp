...
<!-- SHOP CONTENT -->
<div class="shop-content" id="fs-shop-discount">
                    ...
                    <div class="filter-wrap">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                                Sort by:
                                <select id="fs-sort-product-by" fs-category="${braID}">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <span class="pull-right">
                                    Show:
                                    <select id="fs-number-of-item-on-page" fs-category="${braID}">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="pull-right">
                                    ...
                                    <ul class="page_nav fs-ul-page-nav">
                                        <li><span class="fs-page-number fs-page-number-active" fs-page-number="1" fs-category="${braID}">1</span></li>
                                            <c:forEach begin="2" end="${Math.ceil(numberOfProducts/6)}" var="p">
                                            <li><span class="fs-page-number" fs-page-number="${p}" fs-category="${braID}">${p}</span></li>
                                            </c:forEach>
                                    </ul>
                                </div>
                            </div>
...
<!--                        <div class="col-xs-12"  style="padding: 0">
                            ...
                            <div id="slider">
                                <input type="hidden" id="fs-price-from" fs-category="${braID}">
